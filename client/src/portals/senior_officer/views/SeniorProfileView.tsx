...
export const SeniorProfileView: React.FC = () => {
  ...
  const [urgentViolationAlerts, setUrgentViolationAlerts] = useState(true);
        ...
        <div className="text-center sm:text-left flex-1">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2">
            ...
            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#EBF3FA] text-[#174A7E] border border-[#CBD5E1] text-[11px] font-bold w-fit mx-auto sm:mx-0">
              ...
              <span>Senior Metrology Officer</span>
            </span>
          </div>
          <p className="text-xs text-[#64748B] font-medium mt-1">
            Official ID: <span className="font-mono font-bold text-[#1E293B]">{user?.badge_number || 'SO-1002'}</span> &bull; Supervisory Review & Section 36 Adjudication Desk
          </p>
        </div>
      </div>
        ...
        <div className="bg-white rounded-xl border border-[#D8DDE3] shadow-xs overflow-hidden">
          ...
          <div className="p-6 space-y-4 text-xs">
            ...
            <div>
              ...
              <div className="font-mono font-bold text-[#1E293B] mt-0.5">{user?.badge_number || 'SO-1002'}</div>
            </div>
            <div>
              ...
              <div className="font-medium text-[#1E293B] mt-0.5 flex items-center gap-2">
                ...
                <span>{user?.email || 'senior.officer@legalmetrology.gov.in'}</span>
              </div>
            </div>
            <div>
              ...
              <div className="font-medium text-[#1E293B] mt-0.5 flex items-center gap-2">
                ...
                <span>{user?.phone_number || '+91 98765 43211'}</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="p-6 space-y-4 text-xs">
              ...
              <div>
                ...
                <div className="font-semibold text-[#1E293B] mt-0.5">
                  {user?.jurisdiction_district || 'Regional Head Office & State Enforcement Circle 01'}
                </div>
              </div>
              <div>
                ...
                <div className="font-medium text-[#475569] mt-0.5">
                  Legal Metrology (Packaged Commodities) Rules, 2011 & Section 36 Adjudication Powers
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl border border-[#D8DDE3] shadow-xs p-6 flex flex-col justify-between space-y-6">
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <label className="flex items-center justify-between p-3 rounded-lg border border-[#E2E8F0] cursor-pointer hover:bg-[#F8FAFC]">
                <div>
                  <div className="font-bold text-[#1E293B]">New Submission Alerts</div>
                  <div className="text-[11px] text-[#64748B]">Immediate push notifications for submitted inspections</div>
                </div>
                <input
                  type="checkbox"
              ...
              <label className="flex items-center justify-between p-3 rounded-lg border border-[#E2E8F0] cursor-pointer hover:bg-[#F8FAFC]">
                <div>
                  <div className="font-bold text-[#1E293B]">Urgent Violation Flags</div>
                  <div className="text-[11px] text-[#64748B]">Priority alerts for severe statutory non-compliance</div>
                </div>
                <input
                  type="checkbox"
                  checked={urgentViolationAlerts}
                  onChange={(e) => setUrgentViolationAlerts(e.target.checked)}
                  className="w-4 h-4 text-[#174A7E] rounded"
                />
              </label>
              ...
              <label className="flex items-center justify-between p-3 rounded-lg border border-[#E2E8F0] cursor-pointer hover:bg-[#F8FAFC]">
                <div>
                  ...
                  <div className="text-[11px] text-[#64748B]">Daily digests of queue status and finalized orders</div>
                </div>
                <input
                  type="checkbox"
                  checked={emailAlerts}
          ...
          <div className="pt-4 border-t border-[#E2E8F0]">
            ...
            >
              ...
              <span>Sign Out of Senior Officer Account</span>
            </button>
          </div>
        </div>
      </div>
